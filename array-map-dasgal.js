...
//     if (product.rating > topRatedProduct.rating || topRatedProduct === null) {
...
//   products.map((product) => {
//     if (product.price < cheapestProduct.price || cheapestProduct === null) {
...
const getUniqueSuppliers = (products) => {
  ...
  suppliers.forEach((supplier) => {
    uniqueSuppliers[supplier] = "anything";
  });
...
// // 18. Зөвхөн name ба price тайлбартай шинэ массив үүсгэдэг функц бич.
